...
function updateBkgdImg() {
    // Select the body or main tag to apply the background
...
function moveSmiley() {
    // Converts score to string to use it in selecting the corresponding div
    let divId = score.toString();
    let targetDiv = document.getElementById(divId);
    
    if (targetDiv) {
        // Removes the empty Bubble at the target div in order to place the smiley
        targetDiv.innerHTML = '';
        
        // Inserts the smiley image in the target div
